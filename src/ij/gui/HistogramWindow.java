...
public class HistogramWindow extends ImageWindow implements Measurements, ActionListener, ClipboardOwner,
	...
	public HistogramWindow(ImagePlus imp) {
		super(NewImage.createRGBImage("Histogram of "+imp.getShortTitle(), WIN_WIDTH, WIN_HEIGHT, 1, NewImage.FILL_WHITE, false));
	...
	public HistogramWindow(String title, ImagePlus imp, int bins) {
		super(NewImage.createRGBImage(title, WIN_WIDTH, WIN_HEIGHT, 1, NewImage.FILL_WHITE, false));
	...
	private void setup(ImagePlus imp) {
		...
		buttons.add(copy);
		log = new TrimmedButton("Too Much Info ;) Window", trim);
